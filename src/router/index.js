...
const importWallet = resolve =>
  require.ensure([], () => resolve(require('@/components/createWallet/import')), 'group-wallet')
...
const exchangeEnter = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/index')), 'group-exchange')
const top = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/top')), 'group-exchange')
const right = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/right')), 'group-exchange')
const bottom = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/bottom')), 'group-exchange')
const left = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/left')), 'group-exchange')
const middle = resolve =>
  require.ensure([], () => resolve(require('@/components/dapp/exchange/middle')), 'group-exchange')
